...
@section('small-content')
    {{-- <div class="flex-col rules">
        ...
        <ul class="list-disc list-inside">
            <li>Follow our <a href="https://github.com/laravelio/portal/blob/master/CODE_OF_CONDUCT.md" class="text-green-dark">Code of Conduct</a></li>
            <li>Not spam</li>
        ...
        <p>These rules may be changed at any given moment without prior notice.</p>
    </div> --}}
@endsection
